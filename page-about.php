...
<section class="default-header" style="background-image: url(<?php the_field('default_header'); ?>);"></section>
	...
	<section class="mtl-sound">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<h1>the mark thomas lambert sound</h1>
				</div>
			</div>
		</div>
	</section>
	...
	<!-- page title section -->
	<section class="page-title section-background">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="underline-wrap">
	...
	<section class="mtl-history">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<aside>
						<p>That’s when it dawned on me that life is short and I better pursue my music now.</p>
					</aside>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<form action="//markthomaslambert.us15.list-manage.com/subscribe/post?u=af6afaec5ca4509b0e0c26bb0&amp;id=3330f8fd2f" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
					    <div id="mc_embed_signup_scroll">
						<!-- <label for="mce-EMAIL"></label> -->
						<input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="Email Address" required>
					    <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
					    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_af6afaec5ca4509b0e0c26bb0_3330f8fd2f" tabindex="-1" value=""></div>
