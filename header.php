...
<html lang="en">
  ...
  <body <?php body_class(); ?>>
    ...
    <div class="absolute w-full bg-transparent mt-4 px-4">
      <div class="md:grid grid-cols-6">
          <div class="col-span-2">
            <a href="<?php bloginfo('url') ;?>">
              <div class="branding__wrap flex flex-row items-center">
                <svg class="w-14 mr-4" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                <h1 class='text-mtlblue-xlight text-xl uppercase font-semibold hidden md:block'>Mark Thomas Lambert</h1>
              </div>
            </a>

            <div class="group mobile-menu hover:text-mtlorange w-10 md:hidden absolute top-4 right-6 cursor-pointer"> 
              <div class="h-0.5 bg-white group-hover:bg-mtlorange mb-2"></div>
              <div class="h-0.5 bg-white group-hover:bg-mtlorange mb-2"></div>
              <div class="h-0.5 bg-white group-hover:bg-mtlorange"></div>
            </div>
          </div>
          ...
          <div class="col-span-4 hidden md:block">
              <?php
                  wp_nav_menu( array(
                      ...
                      'depth'             => 2,
                      'container_class'   => 'flex items-center justify-end h-full',
                      'menu_class'        => 'mtl-nav flex flex-row text-white text-xs font-bold uppercase',
  ...
  <div class="mobile-navigation fixed h-screen w-screen bg-mtlblue z-10 hidden">
    <div class="px-7 flex flex-row justify-between pt-6">
      ...
      <div class="col">
        <a href="<?php bloginfo('url') ;?>">
          <div class="branding__wrap flex flex-row items-center">
            ...
            <h1 class='text-mtlblue-xlight text-xl uppercase font-semibold hidden sm:block'>Mark Thomas Lambert</h1>
          </div>
        </a>
      </div>

      <div class="flex self-center">
        <span class="text-mtlblue-light hover:text-mtlorange mobile-close-button cursor-pointer">
    ...
    <div class="px-7 pt-12">
      <?php
          wp_nav_menu( array(
              ...
              'depth'             => 2,
              'container_class'   => 'mtl-mobile-menu',
              'menu_class'        => 'text-white text-3xl leading-normal',
              // 'fallback_cb'       => 'wp_bootstrap_navwalker::fallback',
              // 'walker'            => new wp_bootstrap_navwalker())
          )
          );
